/**
 * @flow
 * @relayHash 8d4a2ee12ce372cc6285219eab05c64a
 */
...
type NewTimeslot_viewer$ref = any;
export type router_NewTimeslot_QueryVariables = {||};
export type router_NewTimeslot_QueryResponse = {|
  +viewer: ?{|
    +$fragmentRefs: NewTimeslot_viewer$ref
  |}
|};
export type router_NewTimeslot_Query = {|
  variables: router_NewTimeslot_QueryVariables,
  response: router_NewTimeslot_QueryResponse,
|};
*/
...
fragment SearchModalTimeslot_viewer on Viewer {
  me {
    id
  }
}
...
fragment SummoningInvitedListTimeSlot_viewer on Viewer {
...
fragment InvitedCircleDetailsTimeSlot_viewer on Viewer {
  id
  me {
    id
  }
...
return {
  "kind": "Request",
  "operationKind": "query",
  "name": "router_NewTimeslot_Query",
  "id": null,
  "text": "query router_NewTimeslot_Query {\n  viewer {\n    ...NewTimeslot_viewer\n    id\n  }\n}\n\nfragment NewTimeslot_viewer on Viewer {\n  languages {\n    id\n    name\n    code\n  }\n  ...AddACardPopup_viewer\n  ...VenueOrAddress_viewer\n  ...Opponent_viewer\n  ...Invited_viewer\n  ...Organizers_viewer\n  ...SportSelect_viewer\n  ...DetailsListTimeSlot_viewer\n  ...GroupList_viewer\n  ...PersonList_viewer\n  ...CircleList_viewer\n  ...SearchModalTimeslot_viewer\n  id\n  me {\n    ...Organizers_user\n    id\n    pseudo\n    firstName\n    lastName\n    nationality\n    venues(last: 100) {\n      edges {\n        node {\n          name\n          id\n          infrastructures {\n            id\n            name\n          }\n        }\n      }\n    }\n    sportunityTemplates {\n      id\n      title\n      description\n      kind\n      privacy_switch_preference {\n        privacy_switch_type\n        switch_privacy_x_days_before\n      }\n      invited {\n        user {\n          id\n          pseudo\n          avatar\n        }\n        answer\n      }\n      invited_circles(last: 10) {\n        edges {\n          node {\n            id\n            name\n            members {\n              id\n            }\n            memberStatus {\n              starting_date\n              member {\n                id\n                pseudo\n              }\n              status\n            }\n            owner {\n              id\n              pseudo\n              avatar\n            }\n            type\n            memberCount\n          }\n        }\n      }\n      price_for_circle {\n        circle {\n          id\n        }\n        price {\n          cents\n          currency\n        }\n        participantByDefault\n        excludedParticipantByDefault {\n          excludedMembers {\n            id\n            pseudo\n          }\n        }\n      }\n      notification_preference {\n        notification_type\n        send_notification_x_days_before\n      }\n      participantRange {\n        from\n        to\n      }\n      hide_participant_list\n      price {\n        currency\n        cents\n      }\n      is_repeated_occurence_number\n      number_of_occurences\n      sport {\n        sport {\n          id\n          name {\n            EN\n            DE\n            FR\n            id\n          }\n          logo\n          type\n          sportunityTypes {\n            id\n            isScoreRelevant\n            name {\n              FR\n              EN\n              id\n            }\n          }\n          positions {\n            id\n            EN\n            FR\n            DE\n          }\n          certificates {\n            id\n            name {\n              EN\n              FR\n              DE\n              id\n            }\n          }\n          levels {\n            id\n            EN {\n              name\n              skillLevel\n              description\n            }\n            FR {\n              name\n              skillLevel\n              description\n            }\n            DE {\n              name\n              skillLevel\n              description\n            }\n          }\n          assistantTypes {\n            id\n            name {\n              EN\n              FR\n              DE\n              ES\n              id\n            }\n          }\n        }\n        positions {\n          id\n          EN\n          FR\n          DE\n        }\n        certificates {\n          id\n          name {\n            EN\n            FR\n            DE\n            id\n          }\n        }\n        levels {\n          id\n          EN {\n            name\n            skillLevel\n            description\n          }\n          FR {\n            name\n            skillLevel\n            description\n          }\n          DE {\n            name\n            skillLevel\n            description\n          }\n        }\n      }\n      ageRestriction {\n        from\n        to\n      }\n      sexRestriction\n      address {\n        address\n        country\n        city\n        position {\n          lat\n          lng\n        }\n      }\n      organizers {\n        organizer {\n          id\n          pseudo\n        }\n        isAdmin\n        role\n        price {\n          cents\n          currency\n        }\n        secondaryOrganizerType {\n          id\n          name {\n            FR\n            EN\n            id\n          }\n        }\n        customSecondaryOrganizerType\n        permissions {\n          chatAccess {\n            view\n            edit\n          }\n          memberAccess {\n            view\n            edit\n          }\n          carPoolingAccess {\n            view\n            edit\n          }\n          imageAccess {\n            view\n            edit\n          }\n          detailsAccess {\n            view\n            edit\n          }\n          compositionAccess {\n            view\n            edit\n          }\n        }\n        id\n      }\n      pendingOrganizers {\n        id\n        circles(last: 20) {\n          edges {\n            node {\n              id\n              name\n              memberCount\n              type\n              members {\n                id\n              }\n              owner {\n                id\n                pseudo\n              }\n            }\n          }\n        }\n        isAdmin\n        role\n        price {\n          cents\n          currency\n        }\n        secondaryOrganizerType {\n          id\n          name {\n            FR\n            EN\n            DE\n            ES\n            id\n          }\n        }\n        customSecondaryOrganizerType\n        permissions {\n          chatAccess {\n            view\n            edit\n          }\n          memberAccess {\n            view\n            edit\n          }\n          carPoolingAccess {\n            view\n            edit\n          }\n          imageAccess {\n            view\n            edit\n          }\n          detailsAccess {\n            view\n            edit\n          }\n          compositionAccess {\n            view\n            edit\n          }\n        }\n      }\n      sportunityType {\n        id\n        isScoreRelevant\n        name {\n          FR\n          EN\n          id\n        }\n      }\n      game_information {\n        opponent {\n          organizer {\n            id\n            pseudo\n            avatar\n          }\n          organizerPseudo\n          lookingForAnOpponent\n          invitedOpponents(last: 5) {\n            edges {\n              node {\n                id\n                name\n                memberCount\n              }\n            }\n          }\n          unknownOpponent\n        }\n      }\n    }\n    address {\n      address\n      city\n      country\n    }\n    fees\n    paymentMethods {\n      id\n      cardMask\n      currency\n    }\n    circles(last: 20) {\n      edges {\n        node {\n          id\n          name\n          memberCount\n          type\n          owner {\n            id\n            pseudo\n          }\n          memberStatus {\n            starting_date\n            member {\n              id\n              pseudo\n            }\n            status\n          }\n          circlePreferences {\n            isChildrenCircle\n          }\n          members {\n            id\n            pseudo\n          }\n          sport {\n            sport {\n              id\n              name {\n                FR\n                id\n              }\n            }\n          }\n        }\n      }\n    }\n    circlesUserIsIn(last: 20) {\n      edges {\n        node {\n          id\n          isCircleUsableByMembers\n          name\n          type\n          memberStatus {\n            starting_date\n            member {\n              id\n              pseudo\n            }\n            status\n          }\n          owner {\n            id\n            pseudo\n            avatar\n          }\n          members {\n            id\n            pseudo\n          }\n          memberCount\n          sport {\n            sport {\n              id\n              name {\n                FR\n                id\n              }\n            }\n          }\n        }\n      }\n    }\n    circlesFromClub(last: 20) {\n      edges {\n        node {\n          id\n          name\n          type\n          memberStatus {\n            starting_date\n            member {\n              id\n              pseudo\n            }\n            status\n          }\n          owner {\n            id\n            pseudo\n            avatar\n          }\n          memberCount\n          members {\n            id\n            pseudo\n          }\n          sport {\n            sport {\n              id\n              name {\n                FR\n                id\n              }\n            }\n          }\n        }\n      }\n    }\n    bankAccount {\n      id\n      addressLine1\n      addressLine2\n      city\n      postalCode\n      country\n      ownerName\n      IBAN\n      BIC\n    }\n    profileType\n    isProfileComplete\n    shouldDeclareVAT\n    birthday\n    business {\n      businessName\n      businessEmail\n      headquarterAddress {\n        address\n        city\n        country\n      }\n      VATNumber\n    }\n    areStatisticsActivated\n  }\n  sportunity {\n    id\n    title\n    description\n    kind\n    privacy_switch_preference {\n      privacy_switch_type\n      switch_privacy_x_days_before\n    }\n    participants {\n      id\n      avatar\n      pseudo\n    }\n    waiting {\n      id\n      pseudo\n      avatar\n    }\n    invited {\n      user {\n        id\n        pseudo\n        avatar\n      }\n      answer\n    }\n    survey {\n      isSurveyTransformed\n      surveyDates {\n        beginning_date\n        ending_date\n      }\n    }\n    invited_circles(last: 10) {\n      edges {\n        node {\n          id\n          name\n          memberStatus {\n            starting_date\n            member {\n              id\n              pseudo\n            }\n            status\n          }\n          members {\n            id\n          }\n          owner {\n            id\n            pseudo\n            avatar\n          }\n          type\n          memberCount\n        }\n      }\n    }\n    price_for_circle {\n      circle {\n        id\n      }\n      price {\n        cents\n        currency\n      }\n      participantByDefault\n      excludedParticipantByDefault {\n        excludedMembers {\n          id\n          pseudo\n        }\n      }\n    }\n    notification_preference {\n      notification_type\n      send_notification_x_days_before\n    }\n    participantRange {\n      from\n      to\n    }\n    hide_participant_list\n    beginning_date\n    ending_date\n    price {\n      currency\n      cents\n    }\n    is_repeated_occurence_number\n    number_of_occurences\n    sport {\n      sport {\n        id\n        name {\n          EN\n          DE\n          FR\n          id\n        }\n        logo\n        positions {\n          id\n          EN\n          FR\n          DE\n        }\n        certificates {\n          id\n          name {\n            EN\n            FR\n            DE\n            id\n          }\n        }\n        levels {\n          id\n          EN {\n            name\n            skillLevel\n            description\n          }\n          FR {\n            name\n            skillLevel\n            description\n          }\n          DE {\n            name\n            skillLevel\n            description\n          }\n        }\n        type\n        sportunityTypes {\n          id\n          isScoreRelevant\n          name {\n            FR\n            EN\n            id\n          }\n        }\n        assistantTypes {\n          id\n          name {\n            EN\n            FR\n            DE\n            ES\n            id\n          }\n        }\n      }\n      positions {\n        id\n        EN\n        FR\n        DE\n      }\n      certificates {\n        id\n        name {\n          EN\n          FR\n          DE\n          id\n        }\n      }\n      levels {\n        id\n        EN {\n          name\n          skillLevel\n          description\n        }\n        FR {\n          name\n          skillLevel\n          description\n        }\n        DE {\n          name\n          skillLevel\n          description\n        }\n      }\n    }\n    ageRestriction {\n      from\n      to\n    }\n    sexRestriction\n    address {\n      address\n      country\n      city\n      position {\n        lat\n        lng\n      }\n    }\n    organizers {\n      organizer {\n        id\n        pseudo\n      }\n      isAdmin\n      role\n      price {\n        cents\n        currency\n      }\n      secondaryOrganizerType {\n        id\n        name {\n          FR\n          EN\n          DE\n          ES\n          id\n        }\n      }\n      customSecondaryOrganizerType\n      permissions {\n        chatAccess {\n          view\n          edit\n        }\n        memberAccess {\n          view\n          edit\n        }\n        carPoolingAccess {\n          view\n          edit\n        }\n        imageAccess {\n          view\n          edit\n        }\n        detailsAccess {\n          view\n          edit\n        }\n        compositionAccess {\n          view\n          edit\n        }\n      }\n      id\n    }\n    pendingOrganizers {\n      id\n      circles(last: 20) {\n        edges {\n          node {\n            id\n            name\n            memberCount\n            type\n            members {\n              id\n            }\n            owner {\n              id\n              pseudo\n            }\n          }\n        }\n      }\n      isAdmin\n      role\n      price {\n        cents\n        currency\n      }\n      secondaryOrganizerType {\n        id\n        name {\n          FR\n          EN\n          DE\n          ES\n          id\n        }\n      }\n      customSecondaryOrganizerType\n      permissions {\n        chatAccess {\n          view\n          edit\n        }\n        memberAccess {\n          view\n          edit\n        }\n        carPoolingAccess {\n          view\n          edit\n        }\n        imageAccess {\n          view\n          edit\n        }\n        detailsAccess {\n          view\n          edit\n        }\n        compositionAccess {\n          view\n          edit\n        }\n      }\n    }\n    venue {\n      id\n      name\n      address {\n        address\n        city\n        country\n      }\n    }\n    infrastructure {\n      id\n      name\n    }\n    slot {\n      id\n      from\n      end\n      price {\n        cents\n        currency\n      }\n    }\n    sportunityType {\n      id\n      isScoreRelevant\n      name {\n        FR\n        EN\n        id\n      }\n    }\n    game_information {\n      opponent {\n        organizer {\n          id\n          pseudo\n          avatar\n        }\n        organizerPseudo\n        lookingForAnOpponent\n        invitedOpponents(last: 5) {\n          edges {\n            node {\n              id\n              name\n              memberCount\n            }\n          }\n        }\n        unknownOpponent\n      }\n    }\n    status\n  }\n}\n\nfragment AddACardPopup_viewer on Viewer {\n  id\n}\n\nfragment VenueOrAddress_viewer on Viewer {\n  ...CalendarModal_viewer\n  ...FindPlace_viewer\n  id\n  me {\n    id\n    profileType\n    isSubAccount\n  }\n}\n\nfragment Opponent_viewer on Viewer {\n  me {\n    id\n  }\n}\n\nfragment Invited_viewer on Viewer {\n  ...InvitedList_viewer\n  ...NewCircle_viewer\n  ...SummoningModal_viewer\n  me {\n    id\n    profileType\n    pseudo\n    avatar\n  }\n  invitedUserExists: userExists(pseudo: \"_\", email: \"_\")\n}\n\nfragment Organizers_viewer on Viewer {\n  id\n  ...SearchModal_viewer\n}\n\nfragment SportSelect_viewer on Viewer {\n  id\n  selectSports: sports(first: 10, language: EN) {\n    edges {\n      node {\n        id\n        name {\n          EN\n          FR\n          DE\n          id\n        }\n        logo\n        levels {\n          id\n          EN {\n            name\n            skillLevel\n            description\n          }\n          FR {\n            name\n            skillLevel\n            description\n          }\n          DE {\n            name\n            skillLevel\n            description\n          }\n        }\n        positions {\n          id\n          EN\n          FR\n          DE\n        }\n        certificates {\n          id\n          name {\n            EN\n            FR\n            DE\n            id\n          }\n        }\n        type\n        sportunityTypes {\n          id\n          isScoreRelevant\n          name {\n            FR\n            EN\n            id\n          }\n        }\n      }\n    }\n  }\n}\n\nfragment DetailsListTimeSlot_viewer on Viewer {\n  id\n  ...SummoningInvitedListTimeSlot_viewer\n}\n\nfragment GroupList_viewer on Viewer {\n  ...SummonGroups_viewer\n  me {\n    id\n    profileType\n    pseudo\n    avatar\n  }\n}\n\nfragment PersonList_viewer on Viewer {\n  ...InputUserAutocompleted_viewer\n  me {\n    id\n    profileType\n    pseudo\n    avatar\n  }\n  personListUserExists: userExists(pseudo: \"_\", email: \"_\")\n}\n\nfragment CircleList_viewer on Viewer {\n  me {\n    id\n  }\n}\n\nfragment SearchModalTimeslot_viewer on Viewer {\n  me {\n    id\n  }\n}\n\nfragment Organizers_user on User {\n  id\n  pseudo\n  ...FindOrganizerModal_user\n}\n\nfragment FindOrganizerModal_user on User {\n  id\n}\n\nfragment InputUserAutocompleted_viewer on Viewer {\n  me {\n    id\n  }\n}\n\nfragment SummonGroups_viewer on Viewer {\n  ...NewCircle_viewer\n  ...OwnerSelect_viewer\n  ...SportSelect_viewer\n  me {\n    profileType\n    id\n  }\n}\n\nfragment NewCircle_viewer on Viewer {\n  ...NewCircleAdvanced_viewer\n}\n\nfragment OwnerSelect_viewer on Viewer {\n  me {\n    id\n  }\n}\n\nfragment NewCircleAdvanced_viewer on Viewer {\n  newCircleSports: sports(first: 10, language: EN) {\n    edges {\n      node {\n        id\n        name {\n          id\n          EN\n          FR\n        }\n        logo\n        status\n        levels {\n          id\n          EN {\n            name\n            skillLevel\n            description\n          }\n          FR {\n            name\n            skillLevel\n            description\n          }\n          DE {\n            name\n            skillLevel\n            description\n          }\n        }\n      }\n    }\n  }\n}\n\nfragment SummoningInvitedListTimeSlot_viewer on Viewer {\n  ...InvitedCircleDetailsTimeSlot_viewer\n  me {\n    id\n    pseudo\n    avatar\n    profileType\n  }\n}\n\nfragment InvitedCircleDetailsTimeSlot_viewer on Viewer {\n  id\n  me {\n    id\n  }\n  ...AddUserModal_viewer\n  ...AddMemberModal_viewer\n  ...AddChildModal_viewer\n}\n\nfragment AddUserModal_viewer on Viewer {\n  id\n  ...InputUserAutocompleted_viewer\n}\n\nfragment AddMemberModal_viewer on Viewer {\n  me {\n    id\n  }\n  userExists(pseudo: \"_\", email: \"_\")\n}\n\nfragment AddChildModal_viewer on Viewer {\n  ...SubmitAddChild_viewer\n  ...InputUserAutocompleted_viewer\n  me {\n    id\n  }\n}\n\nfragment SubmitAddChild_viewer on Viewer {\n  id\n}\n\nfragment SearchModal_viewer on Viewer {\n  me {\n    id\n  }\n}\n\nfragment InvitedList_viewer on Viewer {\n  me {\n    id\n    pseudo\n    avatar\n    profileType\n  }\n}\n\nfragment SummoningModal_viewer on Viewer {\n  ...SummoningInvitedList_viewer\n  ...NewCircle_viewer\n  ...OwnerSelect_viewer\n  me {\n    profileType\n    id\n  }\n  summoningModalSports: sports(first: 10, language: EN) {\n    count\n    edges {\n      node {\n        id\n        name {\n          EN\n          FR\n          DE\n          id\n        }\n        logo\n        levels {\n          id\n          EN {\n            name\n            skillLevel\n            description\n          }\n          FR {\n            name\n            skillLevel\n            description\n          }\n          DE {\n            name\n            skillLevel\n            description\n          }\n        }\n      }\n    }\n  }\n}\n\nfragment SummoningInvitedList_viewer on Viewer {\n  ...InvitedCircleDetails_viewer\n  me {\n    id\n    pseudo\n    avatar\n    profileType\n  }\n}\n\nfragment InvitedCircleDetails_viewer on Viewer {\n  id\n  me {\n    id\n  }\n  ...AddUserModal_viewer\n  ...AddMemberModal_viewer\n  ...AddChildModal_viewer\n}\n\nfragment CalendarModal_viewer on Viewer {\n  ...Sidebar_viewer\n  ...CalendarSidebar_viewer\n  ...BigCalendar_viewer\n  id\n  me {\n    id\n  }\n}\n\nfragment FindPlace_viewer on Viewer {\n  id\n  ...CalendarModal_viewer\n}\n\nfragment Sidebar_viewer on Viewer {\n  id\n  ...NewSportunityVenues_viewer\n}\n\nfragment CalendarSidebar_viewer on Viewer {\n  ...NewTimeSlot_viewer\n}\n\nfragment BigCalendar_viewer on Viewer {\n  id\n  ...NewOrEditTimeSlotModal_viewer\n  infrastructure {\n    id\n    name\n    sport {\n      id\n    }\n    logo\n    slots {\n      id\n      from\n      end\n      is_repeated\n      is_repeated_occurence_number\n      number_of_occurences\n      usersSlotIsFor {\n        id\n        pseudo\n        avatar\n      }\n      circlesSlotIsFor(last: 20) {\n        edges {\n          node {\n            id\n            name\n            memberCount\n          }\n        }\n      }\n      price {\n        currency\n        cents\n      }\n      status\n      sportunity {\n        id\n        title\n        organizers {\n          isAdmin\n          organizer {\n            pseudo\n            id\n          }\n          id\n        }\n        cancel_date\n      }\n    }\n  }\n}\n\nfragment NewOrEditTimeSlotModal_viewer on Viewer {\n  me {\n    id\n  }\n  ...Submit_viewer\n  timeSlotUserExists: userExists(pseudo: \"_\", email: \"_\")\n}\n\nfragment Submit_viewer on Viewer {\n  me {\n    id\n    isProfileComplete\n    bankAccount {\n      id\n      addressLine1\n      addressLine2\n      city\n      postalCode\n      country\n      ownerName\n      IBAN\n      BIC\n    }\n  }\n}\n\nfragment NewTimeSlot_viewer on Viewer {\n  ...NewOrEditTimeSlotModal_viewer\n}\n\nfragment NewSportunityVenues_viewer on Viewer {\n  me {\n    id\n    venues(last: 100) {\n      edges {\n        node {\n          id\n          name\n          address {\n            address\n            city\n            country\n          }\n          infrastructures {\n            id\n            name\n            sport {\n              id\n            }\n            slots {\n              id\n              from\n              end\n              price {\n                currency\n                cents\n              }\n            }\n          }\n        }\n      }\n    }\n  }\n}\n",
  "metadata": {},
  "fragment": {
    "kind": "Fragment",
    "name": "router_NewTimeslot_Query",
...
// prettier-ignore
(node/*: any*/).hash = '4be7aaac71c40e7dbe1ae1c76d6ee2a4';
module.exports = node;
