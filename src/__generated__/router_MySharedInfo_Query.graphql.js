/**
 * @flow
 * @relayHash e94b33bbdec333ca472bb5c8c90a834a
 */
...
export type router_MySharedInfo_QueryVariables = {||};
export type router_MySharedInfo_QueryResponse = {|
  +viewer: ?{|
    +$fragmentRefs: MyInfo_viewer$ref
  |}
|};
export type router_MySharedInfo_Query = {|
  variables: router_MySharedInfo_QueryVariables,
  response: router_MySharedInfo_QueryResponse,
|};
*/
...
return {
  "kind": "Request",
  "operationKind": "query",
  "name": "router_MySharedInfo_Query",
  "id": null,
  "text": "query router_MySharedInfo_Query {\n  viewer {\n    ...MyInfo_viewer\n    id\n  }\n}\n\nfragment MyInfo_viewer on Viewer {\n  ...MyInfoInfo_viewer\n  ...Payment_viewer\n  ...BankAccount_viewer\n  ...MyStatisticPreferences_viewer\n  ...AccessRights_viewer\n  ...Wallet_viewer\n  ...Notification_viewer\n  ...Password_viewer\n  ...CirclesInformation_viewer\n  ...CircleMemberships_viewer\n  ...MyUserPreferences_viewer\n  ...SynchronizeCalendar_viewer\n  me {\n    firstName\n    lastName\n    isSubAccount\n    isProfileComplete\n    address {\n      address\n      city\n      country\n    }\n    ...MyInfoInfo_user\n    ...BankAccount_user\n    ...Payment_user\n    ...Notification_user\n    ...Password_user\n    ...MyStatisticPreferences_user\n    ...MyUserPreferences_user\n    ...AccessRights_user\n    ...CirclesInformation_user\n    ...CircleMemberships_user\n    profileType\n    id\n  }\n}\n\nfragment MyInfoInfo_viewer on Viewer {\n  ...InfoLegal_viewer\n  ...InfoNatural_viewer\n  ...Payment_viewer\n  ...BankAccount_viewer\n  ...Wallet_viewer\n}\n\nfragment Payment_viewer on Viewer {\n  me {\n    id\n  }\n}\n\nfragment BankAccount_viewer on Viewer {\n  me {\n    id\n  }\n}\n\nfragment MyStatisticPreferences_viewer on Viewer {\n  id\n  statisticPreferences {\n    private\n    isManOfTheGameActivated\n    userStats {\n      stat0 {\n        name\n        id\n      }\n      stat1 {\n        name\n        id\n      }\n      stat2 {\n        name\n        id\n      }\n      stat3 {\n        name\n        id\n      }\n      stat4 {\n        name\n        id\n      }\n      stat5 {\n        name\n        id\n      }\n    }\n  }\n}\n\nfragment AccessRights_viewer on Viewer {\n  id\n  me {\n    id\n    pseudo\n    email\n    profileType\n    mangoId\n    isProfileComplete\n    isSubAccount\n    userPreferences {\n      areSubAccountsActivated\n    }\n    subAccounts {\n      id\n      pseudo\n      email\n      avatar\n      numberOfUnreadNotifications\n      unreadChats\n      token\n      authorized_managers {\n        user {\n          id\n          avatar\n          pseudo\n        }\n      }\n    }\n  }\n  ...SelectUser_viewer\n  ...SearchModal_viewer\n}\n\nfragment Wallet_viewer on Viewer {\n  ...Transactions_viewer\n  ...Fees_viewer\n  ...PaymentPopup_viewer\n  id\n  me {\n    id\n    pseudo\n    subAccounts {\n      id\n      pseudo\n    }\n    isProfileComplete\n    mangoId\n    bankAccount {\n      id\n    }\n  }\n}\n\nfragment Notification_viewer on Viewer {\n  id\n  me {\n    id\n  }\n}\n\nfragment Password_viewer on Viewer {\n  id\n  me {\n    id\n  }\n}\n\nfragment CirclesInformation_viewer on Viewer {\n  id\n  me {\n    id\n    documents {\n      id\n      name\n      link\n      creation_date\n    }\n  }\n  ...CirclePaymentReference_viewer\n  ...FeesPaymentPopup_viewer\n}\n\nfragment CircleMemberships_viewer on Viewer {\n  id\n  ...CirclePaymentReference_viewer\n  ...FeesPaymentPopup_viewer\n}\n\nfragment MyUserPreferences_viewer on Viewer {\n  id\n}\n\nfragment SynchronizeCalendar_viewer on Viewer {\n  me {\n    id\n    circlesUserIsIn(last: 100) {\n      edges {\n        node {\n          owner {\n            id\n            pseudo\n            avatar\n          }\n          id\n        }\n      }\n    }\n    calendar {\n      users {\n        id\n        pseudo\n      }\n      preferences {\n        own_synchronized_status\n      }\n    }\n  }\n}\n\nfragment MyInfoInfo_user on User {\n  ...InfoLegal_user\n  ...InfoNatural_user\n  ...BankAccount_user\n  ...Payment_user\n  profileType\n  isProfileComplete\n}\n\nfragment BankAccount_user on User {\n  bankAccount {\n    addressLine1\n    addressLine2\n    city\n    postalCode\n    country\n    ownerName\n    IBAN\n    BIC\n    id\n  }\n}\n\nfragment Payment_user on User {\n  firstName\n  lastName\n  email\n  isProfileComplete\n  address {\n    address\n    city\n    country\n    zip\n  }\n  paymentMethods {\n    id\n    cardType\n    cardMask\n    expirationDate\n    currency\n  }\n}\n\nfragment Notification_user on User {\n  id\n  appLanguage\n  notification_preferences {\n    sportunityBooked\n    sportunityBookerCancel\n    sportunityNewInvited\n    sportunityNewFollower\n    sportunityModifiedParticipant\n    sportunityCancelParticipant\n    paymentConfirmationOnDDay\n    sportunityNewMainOrganizer\n    sportunityBookedOrganizer\n    sportunityBookerCancelOrganizer\n    sportunityCancelMainOrganizer\n    sportunityModifiedMainOrganizer\n    paymentReceivedMainOrganizer\n    sportunityCompleteStatistics\n    sportunityVoteForManOfTheGame\n  }\n  email_preferences {\n    sportunityBooked\n    sportunityBookerCancel\n    sportunityNewInvited\n    sportunityNewFollower\n    sportunityModifiedParticipant\n    sportunityCancelParticipant\n    chatUnReadMessage\n    paymentConfirmationOnDDay\n    sportunityNewMainOrganizer\n    sportunityBookedOrganizer\n    sportunityBookerCancelOrganizer\n    sportunityCancelMainOrganizer\n    sportunityModifiedMainOrganizer\n    paymentReceivedMainOrganizer\n  }\n}\n\nfragment Password_user on User {\n  id\n}\n\nfragment MyStatisticPreferences_user on User {\n  id\n  areStatisticsActivated\n}\n\nfragment MyUserPreferences_user on User {\n  id\n  profileType\n  userPreferences {\n    areSubAccountsActivated\n  }\n  homePagePreference\n}\n\nfragment AccessRights_user on User {\n  id\n  profileType\n  authorized_managers {\n    user {\n      id\n      avatar\n      pseudo\n    }\n  }\n}\n\nfragment CirclesInformation_user on User {\n  id\n  mangoId\n  appCurrency\n  circlesInformationCircles: circlesUserIsIn(last: 100) {\n    edges {\n      node {\n        id\n        name\n        owner {\n          pseudo\n          paymentModelFees\n          bankAccount {\n            addressLine1\n            addressLine2\n            city\n            postalCode\n            country\n            ownerName\n            IBAN\n            BIC\n            id\n          }\n          id\n        }\n        askedInformation {\n          id\n          name\n          type\n          answers\n          filledByOwner\n          form {\n            id\n            name\n          }\n        }\n        membersInformation {\n          id\n          information\n          user {\n            id\n          }\n          value\n          document {\n            id\n            name\n          }\n          validationStatus\n          comment\n        }\n        paymentModels {\n          id\n          name\n          paymentViaBankWireAllowed\n          memberToPayFees\n          inAppPaymentAllowed\n          price {\n            cents\n            currency\n          }\n          memberSubscriptions {\n            user {\n              id\n            }\n            amount {\n              cents\n              currency\n            }\n            beginning_date\n            ending_date\n          }\n          conditions {\n            id\n            name\n            price {\n              cents\n              currency\n            }\n            conditions {\n              askedInformation {\n                id\n                type\n              }\n              askedInformationComparator\n              askedInformationComparatorValue\n              askedInformationComparatorValueString\n              askedInformationComparatorDate\n            }\n          }\n        }\n      }\n    }\n  }\n}\n\nfragment CircleMemberships_user on User {\n  id\n  mangoId\n  appCurrency\n  circlesCircleMemberships: circlesUserIsIn(last: 100) {\n    edges {\n      node {\n        id\n        name\n        owner {\n          pseudo\n          paymentModelFees\n          bankAccount {\n            addressLine1\n            addressLine2\n            city\n            postalCode\n            country\n            ownerName\n            IBAN\n            BIC\n            id\n          }\n          id\n        }\n        askedInformation {\n          id\n          name\n          type\n          answers\n          filledByOwner\n          form {\n            id\n            name\n          }\n        }\n        membersInformation {\n          id\n          information\n          user {\n            id\n          }\n          value\n          document {\n            id\n            name\n          }\n          validationStatus\n          comment\n        }\n        paymentModels {\n          id\n          name\n          paymentViaBankWireAllowed\n          memberToPayFees\n          inAppPaymentAllowed\n          price {\n            cents\n            currency\n          }\n          memberSubscriptions {\n            user {\n              id\n            }\n            amount {\n              cents\n              currency\n            }\n            beginning_date\n            ending_date\n          }\n          conditions {\n            id\n            name\n            price {\n              cents\n              currency\n            }\n            conditions {\n              askedInformation {\n                id\n                type\n              }\n              askedInformationComparator\n              askedInformationComparatorValue\n              askedInformationComparatorValueString\n              askedInformationComparatorDate\n            }\n          }\n        }\n      }\n    }\n  }\n}\n\nfragment InfoLegal_user on User {\n  id\n  appCountry\n  profileType\n  email\n  firstName\n  lastName\n  birthday\n  nationality\n  occupation\n  incomeRange\n  shouldDeclareVAT\n  address {\n    address\n    city\n    country\n    zip\n  }\n  business {\n    businessName\n    businessEmail\n    VATNumber\n    headquarterAddress {\n      address\n      city\n      country\n      zip\n    }\n  }\n}\n\nfragment InfoNatural_user on User {\n  id\n  profileType\n  email\n  firstName\n  lastName\n  birthday\n  nationality\n  occupation\n  incomeRange\n  address {\n    address\n    city\n    country\n    zip\n  }\n}\n\nfragment CirclePaymentReference_viewer on Viewer {\n  id\n}\n\nfragment FeesPaymentPopup_viewer on Viewer {\n  id\n  ...AddACard_viewer\n  me {\n    id\n    mangoId\n    bankAccount {\n      id\n      addressLine1\n      addressLine2\n      city\n      postalCode\n      country\n      ownerName\n      IBAN\n      BIC\n    }\n    paymentMethods {\n      id\n      cardMask\n      cardType\n      expirationDate\n      currency\n    }\n  }\n  amountOnWallet {\n    amountOnWallet {\n      cents\n      currency\n    }\n    amountOnWallets {\n      cents\n      currency\n    }\n    lockedAmount {\n      cents\n      currency\n    }\n  }\n}\n\nfragment AddACard_viewer on Viewer {\n  me {\n    id\n    lastName\n  }\n}\n\nfragment Transactions_viewer on Viewer {\n  me {\n    id\n  }\n}\n\nfragment Fees_viewer on Viewer {\n  ...FeesPaymentPopup_viewer\n  me {\n    id\n  }\n}\n\nfragment PaymentPopup_viewer on Viewer {\n  id\n  me {\n    id\n    bankAccount {\n      id\n      addressLine1\n      addressLine2\n      city\n      postalCode\n      country\n      ownerName\n      IBAN\n      BIC\n    }\n    paymentMethods {\n      id\n      cardMask\n      cardType\n      expirationDate\n      currency\n    }\n  }\n  amountOnWallet {\n    amountOnWallet {\n      cents\n      currency\n    }\n    amountOnWallets {\n      cents\n      currency\n    }\n    lockedAmount {\n      cents\n      currency\n    }\n  }\n}\n\nfragment SelectUser_viewer on Viewer {\n  me {\n    id\n  }\n}\n\nfragment SearchModal_viewer on Viewer {\n  me {\n    id\n  }\n}\n\nfragment InfoLegal_viewer on Viewer {\n  languages {\n    id\n    name\n    code\n  }\n  me {\n    id\n  }\n}\n\nfragment InfoNatural_viewer on Viewer {\n  languages {\n    id\n    name\n    code\n  }\n  me {\n    id\n  }\n}\n",
  "metadata": {},
  "fragment": {
    "kind": "Fragment",
    "name": "router_MySharedInfo_Query",
...
// prettier-ignore
(node/*: any*/).hash = '0bd0d56d6bf946c51f9549dc52f652c5';
module.exports = node;
