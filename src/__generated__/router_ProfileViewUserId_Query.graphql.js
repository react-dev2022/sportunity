/**
 * @flow
 * @relayHash ec52128a1189999709f6aae1b6e6a984
 */
...
export type router_ProfileViewUserId_QueryVariables = {|
  userId: string,
  queryChat: boolean,
  ...
  first?: ?number,
|};
export type router_ProfileViewUserId_QueryResponse = {|
  +viewer: ?{|
    +$fragmentRefs: ProfileView_viewer$ref
  |}
|};
export type router_ProfileViewUserId_Query = {|
  variables: router_ProfileViewUserId_QueryVariables,
  response: router_ProfileViewUserId_QueryResponse,
|};
*/
...
query router_ProfileViewUserId_Query(
  ...
  viewer {
    ...ProfileView_viewer_1mc8xC
    id
  }
}

fragment ProfileView_viewer_1mc8xC on Viewer {
...
var v0 = [
  ...
  {
    "kind": "LocalArgument",
    "name": "queryStatsIndividual",
    "type": "Boolean!",
    "defaultValue": null
  },
  {
    "kind": "LocalArgument",
    "name": "queryStatsClubs",
    "type": "Boolean!",
    "defaultValue": null
  },
  {
    "kind": "LocalArgument",
    "name": "queryStatsTeams",
    "type": "Boolean!",
    "defaultValue": null
  },
  {
...
return {
  "kind": "Request",
  "operationKind": "query",
  "name": "router_ProfileViewUserId_Query",
  "id": null,
  "text": "query router_ProfileViewUserId_Query(\n  $userId: String!\n  $first: Int\n) {\n  viewer {\n    ...ProfileView_viewer_1mc8xC\n    id\n  }\n}\n\nfragment ProfileView_viewer_1mc8xC on Viewer {\n  ...ProfileViewHeader_viewer\n  ...Content_viewer\n  ...OrganizedSportunitiesStatistics_viewer\n  ...TeamsStats_viewer\n  ...ClubsStats_viewer\n  ...IndividualStats_viewer\n  ...ProfileViewChat_viewer\n  ...ProfileViewEvents_viewer\n  ...Teams_viewer\n  id\n  statisticPreferences(userID: $userId) {\n    private\n  }\n  me {\n    id\n    ...Content_me\n    ...ProfileViewHeader_me\n    ...ProfileViewChat_me\n  }\n  user(id: $userId) {\n    pseudo\n    avatar\n    areStatisticsActivated\n    profileType\n    isSubAccount\n    subAccounts {\n      id\n      pseudo\n      avatar\n      userStatistics {\n        averageNumberOfParticipatedWeek\n        averageNumberOfParticipatedMonth\n        averageNumberOfParticipatedYear\n      }\n    }\n    sportunities(first: $first) {\n      count\n      ...ProfileViewEvents_sportunities\n    }\n    ...Teams_user\n    ...Content_user\n    ...Sidebar_user\n    ...TeamsStats_user\n    ...ClubsStats_user\n    ...IndividualStats_user\n    ...ProfileViewHeader_user\n    id\n  }\n  chat(userId: $userId) {\n    ...ProfileViewChat_chat\n    id\n  }\n  sportunities(first: $first, userId: $userId, filter: {status: MySportunities}) {\n    count\n    ...ProfileViewEvents_sportunities\n  }\n}\n\nfragment ProfileViewHeader_viewer on Viewer {\n  id\n  me {\n    id\n  }\n  sportunitiesCount: sportunities(last: 2, filter: {status: MySportunities}) {\n    count\n  }\n}\n\nfragment Content_viewer on Viewer {\n  id\n  ...ProfileSports_viewer\n  languages {\n    ...Languages_languages\n    id\n  }\n  me {\n    id\n    avatar\n    birthday\n    hideMyAge\n    languages {\n      id\n      code\n      name\n      ...Languages_languages\n    }\n  }\n}\n\nfragment OrganizedSportunitiesStatistics_viewer on Viewer {\n  id\n}\n\nfragment TeamsStats_viewer on Viewer {\n  ...FillStatsModal_viewer\n  me {\n    id\n  }\n}\n\nfragment ClubsStats_viewer on Viewer {\n  me {\n    id\n  }\n}\n\nfragment IndividualStats_viewer on Viewer {\n  ...CircleItem_viewer\n  me {\n    id\n  }\n}\n\nfragment ProfileViewChat_viewer on Viewer {\n  id\n  me {\n    id\n    avatar\n  }\n}\n\nfragment ProfileViewEvents_viewer on Viewer {\n  ...Sportunity_viewer\n}\n\nfragment Teams_viewer on Viewer {\n  id\n  me {\n    id\n    pseudo\n  }\n}\n\nfragment Content_me on User {\n  id\n  blackList {\n    id\n  }\n}\n\nfragment ProfileViewHeader_me on User {\n  id\n  ...AddToCalendar_me\n}\n\nfragment ProfileViewChat_me on User {\n  id\n  avatar\n}\n\nfragment ProfileViewEvents_sportunities on SportunityConnection {\n  pageInfo {\n    hasNextPage\n  }\n  edges {\n    node {\n      ...Sportunity_sportunity\n      id\n      title\n      beginning_date\n      ending_date\n      venue {\n        name\n        id\n      }\n      participants {\n        id\n      }\n      price {\n        currency\n        cents\n      }\n      mode\n      kind\n    }\n  }\n}\n\nfragment Teams_user on User {\n  id\n  pseudo\n  subAccounts {\n    id\n    pseudo\n    avatar\n    sportunityNumber\n    allCircleMembers {\n      user {\n        id\n      }\n    }\n  }\n}\n\nfragment Content_user on User {\n  ...StatsSummary_user\n  id\n  profileType\n  sex\n  birthday\n  hideMyAge\n  avatar\n  pseudo\n  publicAddress {\n    position {\n      lat\n      lng\n    }\n  }\n  description\n  languages {\n    id\n    code\n    name\n  }\n  ...ProfileGroups_user\n  sports {\n    ...ProfileSports_sports\n    sport {\n      id\n      type\n      logo\n      name {\n        EN\n        DE\n        FR\n        id\n      }\n    }\n    levels {\n      id\n      EN {\n        name\n      }\n      DE {\n        name\n      }\n      FR {\n        name\n      }\n    }\n    positions {\n      id\n      EN\n      DE\n      FR\n    }\n    certificates {\n      certificate {\n        id\n        name {\n          EN\n          FR\n          DE\n          id\n        }\n      }\n    }\n    assistantType {\n      id\n      name {\n        EN\n        DE\n        FR\n        id\n      }\n    }\n  }\n  isPublicProfileComplete\n  ...Feedbacks_user\n}\n\nfragment Sidebar_user on User {\n  circles(last: 10) {\n    edges {\n      node {\n        id\n        name\n      }\n    }\n  }\n}\n\nfragment TeamsStats_user on User {\n  pseudo\n  id\n  areStatisticsActivated\n  ...FillStatsModal_user\n  statisticFilters {\n    id\n    name\n    date_begin\n    date_end\n    circleList(first: 20) {\n      edges {\n        node {\n          id\n          name\n        }\n      }\n    }\n  }\n  defaultStatisticFilter {\n    id\n    name\n    date_begin\n    date_end\n    circleList(first: 20) {\n      edges {\n        node {\n          id\n        }\n      }\n    }\n  }\n  circles(last: 10) {\n    edges {\n      node {\n        id\n        name\n        memberCount\n        type\n      }\n    }\n  }\n}\n\nfragment ClubsStats_user on User {\n  pseudo\n  id\n}\n\nfragment IndividualStats_user on User {\n  ...StatsSummary_user\n  pseudo\n  id\n  circlesUserIsIn(first: 4) {\n    edges {\n      node {\n        ...MyCirclesCircleItem_circle\n        id\n        owner {\n          id\n          avatar\n          profileType\n          pseudo\n          publicAddress {\n            address\n            city\n            country\n          }\n          sports {\n            sport {\n              id\n              logo\n              name {\n                EN\n                FR\n                id\n              }\n            }\n            levels {\n              id\n              EN {\n                name\n              }\n              FR {\n                name\n              }\n            }\n          }\n        }\n        name\n        memberCount\n      }\n    }\n    count\n  }\n  sports {\n    sport {\n      id\n    }\n  }\n}\n\nfragment ProfileViewHeader_user on User {\n  id\n  pseudo\n  avatar\n  publicAddress {\n    city\n    country\n  }\n  sportunitiesCount: sportunities(last: 2) {\n    count\n  }\n  followers {\n    id\n  }\n}\n\nfragment ProfileViewChat_chat on Chat {\n  id\n  isActive\n  messages(last: 20) {\n    count\n    edges {\n      node {\n        ...Message_message\n        id\n      }\n    }\n  }\n}\n\nfragment Message_message on Message {\n  id\n  text\n  author {\n    id\n    pseudo\n    avatar\n  }\n  created\n}\n\nfragment StatsSummary_user on User {\n  id\n  userStatistics {\n    numberOfParticipated\n    averageNumberOfParticipatedWeek\n    averageNumberOfParticipatedMonth\n    averageNumberOfParticipatedYear\n    membersUserParticipatesWith {\n      number\n    }\n  }\n}\n\nfragment MyCirclesCircleItem_circle on Circle {\n  id\n  name\n  mode\n  type\n  isCircleUpdatableByMembers\n  isCircleUsableByMembers\n  isCurrentUserAMember\n  shouldValidateNewUser\n  memberCount\n  waitingMembers {\n    id\n  }\n  refusedMembers {\n    id\n  }\n  owner {\n    id\n    pseudo\n    avatar\n  }\n  address {\n    address\n    city\n    country\n  }\n  termsOfUses {\n    id\n  }\n  sport {\n    sport {\n      id\n      logo\n      name {\n        FR\n        EN\n        ES\n        DE\n        id\n      }\n    }\n    levels {\n      FR {\n        name\n        description\n      }\n      EN {\n        name\n        description\n      }\n      ES {\n        name\n        description\n      }\n      DE {\n        name\n        description\n      }\n      id\n    }\n  }\n}\n\nfragment FillStatsModal_user on User {\n  id\n  statSportunities: sportunities(first: 100) {\n    edges {\n      node {\n        ...SportunityRow_sportunity\n        id\n        title\n        beginning_date\n        sport {\n          sport {\n            type\n            sportunityTypes {\n              id\n              name {\n                FR\n                EN\n                DE\n                ES\n                id\n              }\n            }\n            id\n          }\n        }\n        sportunityType {\n          id\n          name {\n            EN\n            FR\n            DE\n            ES\n            id\n          }\n          statuses {\n            id\n            name {\n              FR\n              EN\n              DE\n              ES\n              id\n            }\n          }\n          isScoreRelevant\n        }\n        game_information {\n          opponent {\n            organizer {\n              id\n              pseudo\n            }\n            unknownOpponent\n            invitedOpponents(first: 20) {\n              edges {\n                node {\n                  name\n                  id\n                }\n              }\n            }\n          }\n        }\n        score {\n          currentTeam\n          adversaryTeam\n        }\n        sportunityTypeStatus {\n          id\n          name {\n            EN\n            FR\n            DE\n            ES\n            id\n          }\n        }\n      }\n    }\n  }\n}\n\nfragment SportunityRow_sportunity on Sportunity {\n  id\n  title\n  beginning_date\n  sport {\n    sport {\n      type\n      sportunityTypes {\n        id\n        name {\n          FR\n          EN\n          DE\n          ES\n          id\n        }\n        statuses {\n          id\n          name {\n            FR\n            EN\n            DE\n            ES\n            id\n          }\n        }\n        isScoreRelevant\n      }\n      id\n    }\n  }\n  sportunityType {\n    id\n    name {\n      EN\n      FR\n      DE\n      ES\n      id\n    }\n    statuses {\n      id\n      name {\n        FR\n        EN\n        DE\n        ES\n        id\n      }\n    }\n    isScoreRelevant\n  }\n  game_information {\n    opponent {\n      organizer {\n        id\n        pseudo\n      }\n      unknownOpponent\n      invitedOpponents(first: 20) {\n        edges {\n          node {\n            name\n            id\n          }\n        }\n      }\n    }\n  }\n  score {\n    currentTeam\n    adversaryTeam\n  }\n  sportunityTypeStatus {\n    id\n    name {\n      EN\n      FR\n      DE\n      ES\n      id\n    }\n  }\n}\n\nfragment ProfileGroups_user on User {\n  id\n  circles(last: 10) {\n    edges {\n      node {\n        ...MyCirclesCircleItem_circle\n        id\n        name\n        mode\n        owner {\n          id\n          pseudo\n        }\n      }\n    }\n    count\n  }\n}\n\nfragment ProfileSports_sports on SportDescriptor {\n  sport {\n    id\n    name {\n      EN\n      FR\n      DE\n      id\n    }\n    logo\n  }\n  levels {\n    id\n    EN {\n      name\n    }\n    FR {\n      name\n    }\n    DE {\n      name\n    }\n  }\n  certificates {\n    certificate {\n      name {\n        EN\n        FR\n        DE\n        id\n      }\n      id\n    }\n  }\n  positions {\n    EN\n    FR\n    DE\n    id\n  }\n  assistantType {\n    name {\n      EN\n      FR\n      DE\n      id\n    }\n    id\n  }\n}\n\nfragment Feedbacks_user on User {\n  feedbacks {\n    count\n    averageRating\n    feedbacksList(first: 5) {\n      edges {\n        node {\n          id\n          text\n          rating\n          createdAt\n          author {\n            id\n            pseudo\n            avatar\n          }\n        }\n      }\n    }\n  }\n}\n\nfragment Sportunity_sportunity on Sportunity {\n  id\n  title\n  description\n  beginning_date\n  ending_date\n  survey {\n    isSurveyTransformed\n    surveyDates {\n      answers {\n        user {\n          id\n          pseudo\n        }\n        answer\n      }\n    }\n  }\n  sportunityType {\n    id\n    name {\n      EN\n      FR\n      id\n    }\n  }\n  sportunityTypeStatus {\n    id\n    name {\n      EN\n      FR\n      id\n    }\n  }\n  score {\n    currentTeam\n    adversaryTeam\n  }\n  game_information {\n    opponent {\n      organizerPseudo\n      unknownOpponent\n      lookingForAnOpponent\n      organizer {\n        id\n        pseudo\n        avatar\n      }\n      invitedOpponents(last: 5) {\n        edges {\n          node {\n            id\n            members {\n              id\n            }\n          }\n        }\n      }\n    }\n  }\n  address {\n    address\n    city\n    country\n    position {\n      lat\n      lng\n    }\n  }\n  status\n  kind\n  venue {\n    id\n    name\n  }\n  infrastructure {\n    id\n    name\n  }\n  participants {\n    id\n  }\n  price {\n    currency\n    cents\n  }\n  paymentStatus {\n    status\n    user {\n      id\n    }\n    price {\n      currency\n      cents\n    }\n    id\n  }\n  organizers {\n    organizer {\n      id\n      pseudo\n      avatar\n    }\n    isAdmin\n    role\n    secondaryOrganizerType {\n      id\n      name {\n        FR\n        EN\n        DE\n        ES\n        id\n      }\n    }\n    customSecondaryOrganizerType\n    id\n  }\n  sport {\n    sport {\n      logo\n      id\n      name {\n        EN\n        FR\n        DE\n        id\n      }\n      assistantTypes {\n        id\n        name {\n          FR\n          EN\n          DE\n          ES\n          id\n        }\n      }\n      levels {\n        id\n        EN {\n          name\n          skillLevel\n        }\n        FR {\n          name\n          skillLevel\n        }\n        DE {\n          name\n          skillLevel\n        }\n      }\n    }\n    allLevelSelected\n    levels {\n      id\n      EN {\n        name\n        skillLevel\n      }\n      FR {\n        name\n        skillLevel\n      }\n      DE {\n        name\n        skillLevel\n      }\n    }\n  }\n}\n\nfragment AddToCalendar_me on User {\n  id\n  calendar {\n    sportunities(last: 100) {\n      edges {\n        node {\n          id\n        }\n      }\n    }\n    users {\n      id\n    }\n  }\n}\n\nfragment Sportunity_viewer on Viewer {\n  id\n  me {\n    id\n    profileType\n    subAccounts {\n      id\n    }\n  }\n  sportunity {\n    ...Sportunity_sportunity\n    id\n  }\n}\n\nfragment CircleItem_viewer on Viewer {\n  circle {\n    id\n    name\n    mode\n    owner {\n      id\n      pseudo\n      avatar\n      profileType\n    }\n    isCircleUpdatableByMembers\n    isCircleUsableByMembers\n    memberCount\n  }\n}\n\nfragment FillStatsModal_viewer on Viewer {\n  id\n}\n\nfragment ProfileSports_viewer on Viewer {\n  ...AddSport_viewer\n}\n\nfragment Languages_languages on Language {\n  id\n  code\n  name\n}\n\nfragment AddSport_viewer on Viewer {\n  sports(first: 10, language: EN) {\n    edges {\n      node {\n        id\n        type\n        name {\n          EN\n          FR\n          DE\n          id\n        }\n        logo\n        positions {\n          id\n          EN\n          FR\n          DE\n        }\n        certificates {\n          id\n          name {\n            id\n            EN\n            FR\n            DE\n          }\n        }\n        levels {\n          id\n          EN {\n            skillLevel\n            name\n            description\n          }\n          FR {\n            skillLevel\n            name\n            description\n          }\n          DE {\n            skillLevel\n            name\n            description\n          }\n        }\n        assistantTypes {\n          id\n          name {\n            EN\n            FR\n            DE\n            id\n          }\n        }\n      }\n    }\n  }\n}\n",
  "metadata": {},
  "fragment": {
    "kind": "Fragment",
    "name": "router_ProfileViewUserId_Query",
        ...
        "selections": [
          {
            ...
            "args": [
              ...
              },
              {
                "kind": "Variable",
                "name": "queryStatsClubs",
                "variableName": "queryStatsClubs",
                "type": null
              },
              {
                "kind": "Variable",
                "name": "queryStatsIndividual",
                "variableName": "queryStatsIndividual",
                "type": null
              },
              {
                "kind": "Variable",
                "name": "queryStatsTeams",
                "variableName": "queryStatsTeams",
                "type": null
              },
              {
                "kind": "Variable",
...
// prettier-ignore
(node/*: any*/).hash = '1917fbc37ccf631e2a868e3a0ff547ab';
module.exports = node;
