/**
 * @flow
 * @relayHash 4dee0d516eb4eef813ec23b088df25eb
 */
...
export type router_JoinCircle_QueryVariables = {|
  userToken?: ?string,
  ...
  circleId?: ?string,
|};
export type router_JoinCircle_QueryResponse = {|
  +viewer: ?{|
    +$fragmentRefs: Circle_viewer$ref
  |}
|};
export type router_JoinCircle_Query = {|
  variables: router_JoinCircle_QueryVariables,
  response: router_JoinCircle_QueryResponse,
|};
*/
...
return {
  "kind": "Request",
  "operationKind": "query",
  "name": "router_JoinCircle_Query",
  "id": null,
  "text": "query router_JoinCircle_Query(\n  $userToken: String\n  $queryAuthorizedAccounts: Boolean!\n  $superToken: String\n  $querySuperMe: Boolean!\n  $circleId: ID\n) {\n  viewer {\n    ...Circle_viewer_4EdedD\n    id\n  }\n}\n\nfragment Circle_viewer_4EdedD on Viewer {\n  id\n  ...CircleStats_viewer\n  ...AddMember_viewer\n  ...Subscribe_viewer\n  ...EditCircle_viewer\n  ...MemberCard_viewer\n  ...MemberRow_viewer\n  ...CircleMembersInformation_viewer\n  ...CircleHeader_viewer\n  ...Activities_viewer\n  ...ChatContainer_viewer\n  ...TermOfUseModal_viewer\n  me {\n    ...CircleHeader_user\n    ...Activities_user\n    id\n    pseudo\n    avatar\n    profileType\n    isSubAccount\n    meCircles: circles(last: 20) {\n      edges {\n        node {\n          id\n          name\n          memberCount\n        }\n      }\n    }\n    meCirclesCirclesFromClub: circlesFromClub(last: 100) {\n      edges {\n        node {\n          id\n          name\n          owner {\n            id\n            pseudo\n            avatar\n          }\n          memberCount\n          members {\n            id\n            pseudo\n            avatar\n          }\n        }\n      }\n    }\n  }\n  authorizedAccounts(userToken: $userToken) @include(if: $queryAuthorizedAccounts) {\n    id\n    avatar\n    pseudo\n    accounts {\n      id\n      avatar\n      token\n      pseudo\n    }\n  }\n  superMe(superToken: $superToken) @include(if: $querySuperMe) {\n    id\n    pseudo\n    avatar\n    profileType\n    subAccounts {\n      id\n      avatar\n      pseudo\n      token\n    }\n  }\n  circle(id: $circleId) {\n    ...CircleHeader_circle\n    ...Details_circle\n    ...Activities_circle\n    ...TermOfUseModal_circle\n    circleSportunities: sportunities {\n      edges {\n        node {\n          status\n          id\n        }\n      }\n    }\n    termsOfUses {\n      id\n      name\n      link\n      content\n      acceptedBy {\n        user {\n          id\n        }\n      }\n    }\n    memberStatus {\n      member {\n        id\n      }\n      status\n      starting_date\n    }\n    description\n    id\n    name\n    address {\n      address\n      city\n      country\n      position {\n        lat\n        lng\n      }\n    }\n    owner {\n      id\n      pseudo\n      avatar\n      ...CircleStats_user\n      profileType\n    }\n    coOwners {\n      id\n    }\n    memberCount\n    mode\n    type\n    isCircleUpdatableByMembers\n    isCircleUsableByMembers\n    isCircleAccessibleFromUrl\n    shouldValidateNewUser\n    isChatActive\n    circlePreferences {\n      isChildrenCircle\n    }\n    waitingMembers {\n      id\n      pseudo\n      firstName\n      lastName\n      avatar\n      lastConnexionDate\n    }\n    refusedMembers {\n      id\n      pseudo\n      firstName\n      lastName\n      avatar\n      lastConnexionDate\n    }\n    members {\n      id\n      pseudo\n      firstName\n      lastName\n      avatar\n      lastConnexionDate\n      sports {\n        sport {\n          id\n          name {\n            EN\n            FR\n            DE\n            id\n          }\n        }\n      }\n      circlesUserIsIn(last: 20) {\n        edges {\n          node {\n            id\n            name\n            owner {\n              id\n              pseudo\n              avatar\n            }\n            mode\n            isCircleUpdatableByMembers\n            isCircleUsableByMembers\n            memberCount\n          }\n        }\n      }\n      sportunityNumber\n      followers {\n        id\n      }\n    }\n    sport {\n      sport {\n        id\n        logo\n        name {\n          EN\n          FR\n          id\n        }\n        levels {\n          id\n          EN {\n            name\n            skillLevel\n            description\n          }\n          FR {\n            name\n            skillLevel\n            description\n          }\n        }\n      }\n      levels {\n        id\n        EN {\n          name\n          skillLevel\n          description\n        }\n        FR {\n          name\n          skillLevel\n          description\n        }\n      }\n    }\n    memberParents {\n      subAccounts {\n        id\n      }\n      id\n      pseudo\n      firstName\n      lastName\n      avatar\n      lastConnexionDate\n      sports {\n        sport {\n          id\n          name {\n            EN\n            FR\n            DE\n            id\n          }\n        }\n      }\n      sportunityNumber\n      followers {\n        id\n      }\n    }\n    subCircles(last: 20) {\n      edges {\n        node {\n          id\n          members {\n            id\n          }\n        }\n      }\n    }\n    askedInformation {\n      id\n      name\n      type\n      filledByOwner\n    }\n    membersInformation {\n      id\n      information\n      user {\n        id\n      }\n      value\n      document {\n        id\n        name\n      }\n      validationStatus\n      comment\n    }\n  }\n}\n\nfragment CircleStats_viewer on Viewer {\n  me {\n    id\n  }\n}\n\nfragment AddMember_viewer on Viewer {\n  me {\n    id\n  }\n  ...SearchModal_viewer\n  ...AddChildModal_viewer\n}\n\nfragment Subscribe_viewer on Viewer {\n  id\n  me {\n    id\n    pseudo\n    avatar\n  }\n}\n\nfragment EditCircle_viewer on Viewer {\n  id\n  sports(first: 10, language: EN) {\n    count\n    edges {\n      node {\n        id\n        name {\n          id\n          EN\n          FR\n        }\n        logo\n        status\n        levels {\n          id\n          EN {\n            name\n            skillLevel\n            description\n          }\n          FR {\n            name\n            skillLevel\n            description\n          }\n          DE {\n            name\n            skillLevel\n            description\n          }\n        }\n      }\n    }\n  }\n}\n\nfragment MemberCard_viewer on Viewer {\n  id\n}\n\nfragment MemberRow_viewer on Viewer {\n  id\n}\n\nfragment CircleMembersInformation_viewer on Viewer {\n  id\n  ...CircleMembersDetailledInformation_viewer\n}\n\nfragment CircleHeader_viewer on Viewer {\n  id\n}\n\nfragment Activities_viewer on Viewer {\n  id\n  ...Sportunity_viewer\n}\n\nfragment ChatContainer_viewer on Viewer {\n  id\n  ...Chat_viewer\n}\n\nfragment TermOfUseModal_viewer on Viewer {\n  id\n  me {\n    id\n  }\n}\n\nfragment CircleHeader_user on User {\n  id\n}\n\nfragment Activities_user on User {\n  id\n}\n\nfragment CircleHeader_circle on Circle {\n  id\n  name\n  owner {\n    id\n    pseudo\n    avatar\n  }\n  memberCount\n  type\n  isCircleUsableByMembers\n  mode\n  address {\n    address\n    city\n    country\n    position {\n      lat\n      lng\n    }\n  }\n  isCircleAccessibleFromUrl\n}\n\nfragment Details_circle on Circle {\n  id\n  description\n  type\n  mode\n  isCircleUsableByMembers\n  publicShortCode\n  address {\n    address\n    city\n    country\n    position {\n      lat\n      lng\n    }\n  }\n  sport {\n    sport {\n      id\n      logo\n      name {\n        EN\n        FR\n        id\n      }\n    }\n    levels {\n      id\n      EN {\n        name\n        skillLevel\n      }\n      FR {\n        name\n        skillLevel\n      }\n    }\n  }\n}\n\nfragment Activities_circle on Circle {\n  id\n}\n\nfragment TermOfUseModal_circle on Circle {\n  id\n  termsOfUses {\n    id\n    name\n    link\n    content\n    acceptedBy {\n      user {\n        id\n      }\n    }\n  }\n}\n\nfragment CircleStats_user on User {\n  id\n  pseudo\n  areStatisticsActivated\n  statisticFilters {\n    id\n    name\n    date_begin\n    date_end\n    circleList(first: 20) {\n      edges {\n        node {\n          id\n          name\n        }\n      }\n    }\n  }\n  statCircles: circles(last: 20) {\n    edges {\n      node {\n        id\n        name\n        memberCount\n        type\n      }\n    }\n  }\n}\n\nfragment Chat_viewer on Viewer {\n  id\n  me {\n    id\n    avatar\n    pseudo\n  }\n}\n\nfragment Sportunity_viewer on Viewer {\n  id\n  me {\n    id\n    profileType\n    subAccounts {\n      id\n    }\n  }\n  sportunity {\n    ...Sportunity_sportunity\n    id\n  }\n}\n\nfragment Sportunity_sportunity on Sportunity {\n  id\n  title\n  description\n  beginning_date\n  ending_date\n  survey {\n    isSurveyTransformed\n    surveyDates {\n      answers {\n        user {\n          id\n          pseudo\n        }\n        answer\n      }\n    }\n  }\n  sportunityType {\n    id\n    name {\n      EN\n      FR\n      id\n    }\n  }\n  sportunityTypeStatus {\n    id\n    name {\n      EN\n      FR\n      id\n    }\n  }\n  score {\n    currentTeam\n    adversaryTeam\n  }\n  game_information {\n    opponent {\n      organizerPseudo\n      unknownOpponent\n      lookingForAnOpponent\n      organizer {\n        id\n        pseudo\n        avatar\n      }\n      invitedOpponents(last: 5) {\n        edges {\n          node {\n            id\n            members {\n              id\n            }\n          }\n        }\n      }\n    }\n  }\n  address {\n    address\n    city\n    country\n    position {\n      lat\n      lng\n    }\n  }\n  status\n  kind\n  venue {\n    id\n    name\n  }\n  infrastructure {\n    id\n    name\n  }\n  participants {\n    id\n  }\n  price {\n    currency\n    cents\n  }\n  paymentStatus {\n    status\n    user {\n      id\n    }\n    price {\n      currency\n      cents\n    }\n    id\n  }\n  organizers {\n    organizer {\n      id\n      pseudo\n      avatar\n    }\n    isAdmin\n    role\n    secondaryOrganizerType {\n      id\n      name {\n        FR\n        EN\n        DE\n        ES\n        id\n      }\n    }\n    customSecondaryOrganizerType\n    id\n  }\n  sport {\n    sport {\n      logo\n      id\n      name {\n        EN\n        FR\n        DE\n        id\n      }\n      assistantTypes {\n        id\n        name {\n          FR\n          EN\n          DE\n          ES\n          id\n        }\n      }\n      levels {\n        id\n        EN {\n          name\n          skillLevel\n        }\n        FR {\n          name\n          skillLevel\n        }\n        DE {\n          name\n          skillLevel\n        }\n      }\n    }\n    allLevelSelected\n    levels {\n      id\n      EN {\n        name\n        skillLevel\n      }\n      FR {\n        name\n        skillLevel\n      }\n      DE {\n        name\n        skillLevel\n      }\n    }\n  }\n}\n\nfragment CircleMembersDetailledInformation_viewer on Viewer {\n  id\n}\n\nfragment SearchModal_viewer on Viewer {\n  me {\n    id\n  }\n}\n\nfragment AddChildModal_viewer on Viewer {\n  ...SubmitAddChild_viewer\n  ...InputUserAutocompleted_viewer\n  me {\n    id\n  }\n}\n\nfragment SubmitAddChild_viewer on Viewer {\n  id\n}\n\nfragment InputUserAutocompleted_viewer on Viewer {\n  me {\n    id\n  }\n}\n",
  "metadata": {},
  "fragment": {
    "kind": "Fragment",
    "name": "router_JoinCircle_Query",
...
// prettier-ignore
(node/*: any*/).hash = 'e3c3065a418461cf1eb7868ef332ac07';
module.exports = node;
