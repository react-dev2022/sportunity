/**
 * @flow
 * @relayHash e86d3bc52e4281b6b89e82b80ef1cc0e
 */
...
export type router_MyWallet_QueryVariables = {||};
export type router_MyWallet_QueryResponse = {|
  +viewer: ?{|
    +$fragmentRefs: Wallet_viewer$ref
  |}
|};
export type router_MyWallet_Query = {|
  variables: router_MyWallet_QueryVariables,
  response: router_MyWallet_QueryResponse,
|};
*/
...
return {
  "kind": "Request",
  "operationKind": "query",
  "name": "router_MyWallet_Query",
  "id": null,
  "text": "query router_MyWallet_Query {\n  viewer {\n    ...Wallet_viewer\n    id\n  }\n}\n\nfragment Wallet_viewer on Viewer {\n  ...Transactions_viewer\n  ...Fees_viewer\n  ...PaymentPopup_viewer\n  id\n  me {\n    id\n    pseudo\n    subAccounts {\n      id\n      pseudo\n    }\n    isProfileComplete\n    mangoId\n    bankAccount {\n      id\n    }\n  }\n}\n\nfragment Transactions_viewer on Viewer {\n  me {\n    id\n  }\n}\n\nfragment Fees_viewer on Viewer {\n  ...FeesPaymentPopup_viewer\n  me {\n    id\n  }\n}\n\nfragment PaymentPopup_viewer on Viewer {\n  id\n  me {\n    id\n    bankAccount {\n      id\n      addressLine1\n      addressLine2\n      city\n      postalCode\n      country\n      ownerName\n      IBAN\n      BIC\n    }\n    paymentMethods {\n      id\n      cardMask\n      cardType\n      expirationDate\n      currency\n    }\n  }\n  amountOnWallet {\n    amountOnWallet {\n      cents\n      currency\n    }\n    amountOnWallets {\n      cents\n      currency\n    }\n    lockedAmount {\n      cents\n      currency\n    }\n  }\n}\n\nfragment FeesPaymentPopup_viewer on Viewer {\n  id\n  ...AddACard_viewer\n  me {\n    id\n    mangoId\n    bankAccount {\n      id\n      addressLine1\n      addressLine2\n      city\n      postalCode\n      country\n      ownerName\n      IBAN\n      BIC\n    }\n    paymentMethods {\n      id\n      cardMask\n      cardType\n      expirationDate\n      currency\n    }\n  }\n  amountOnWallet {\n    amountOnWallet {\n      cents\n      currency\n    }\n    amountOnWallets {\n      cents\n      currency\n    }\n    lockedAmount {\n      cents\n      currency\n    }\n  }\n}\n\nfragment AddACard_viewer on Viewer {\n  me {\n    id\n    lastName\n  }\n}\n",
  "metadata": {},
  "fragment": {
    "kind": "Fragment",
    "name": "router_MyWallet_Query",
...
// prettier-ignore
(node/*: any*/).hash = '3b06c62bddaa5b4aeaed6b373d86771b';
module.exports = node;
