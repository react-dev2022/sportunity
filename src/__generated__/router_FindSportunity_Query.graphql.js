/**
 * @flow
 * @relayHash 3a08985af0c5fec24c2406ae500bb7af
 */
...
export type router_FindSportunity_QueryVariables = {||};
export type router_FindSportunity_QueryResponse = {|
  +viewer: ?{|
    +$fragmentRefs: FindSportunity_viewer$ref
  |}
|};
export type router_FindSportunity_Query = {|
  variables: router_FindSportunity_QueryVariables,
  response: router_FindSportunity_QueryResponse,
|};
*/
...
return {
  "kind": "Request",
  "operationKind": "query",
  "name": "router_FindSportunity_Query",
  "id": null,
  "text": "query router_FindSportunity_Query {\n  viewer {\n    ...FindSportunity_viewer\n    id\n  }\n}\n\nfragment FindSportunity_viewer on Viewer {\n  me {\n    id\n    ...Filter_user\n  }\n  ...Events_viewer\n  ...Filter_viewer\n  sportunities(first: 10) {\n    ...Events_sportunities\n    ...FindSportunityMap_sportunities\n    pageInfo {\n      hasNextPage\n    }\n    count\n  }\n}\n\nfragment Filter_user on User {\n  appCountry\n  circlesUserIsIn(last: 20) {\n    edges {\n      node {\n        id\n        name\n        owner {\n          id\n          pseudo\n          avatar\n        }\n        mode\n        isCircleUpdatableByMembers\n        isCircleUsableByMembers\n        memberCount\n      }\n    }\n  }\n  savedFilters {\n    id\n    page\n    filterName\n    location {\n      lat\n      lng\n      radius\n    }\n    sport {\n      sport {\n        id\n        name {\n          EN\n          FR\n          DE\n          id\n        }\n        levels {\n          id\n          EN {\n            name\n            skillLevel\n            description\n          }\n          FR {\n            name\n            skillLevel\n            description\n          }\n          DE {\n            name\n            skillLevel\n            description\n          }\n        }\n      }\n      levels {\n        id\n        FR {\n          name\n          skillLevel\n          description\n        }\n        EN {\n          name\n          skillLevel\n          description\n        }\n        DE {\n          name\n          skillLevel\n          description\n        }\n      }\n    }\n    price {\n      from\n      to\n    }\n    dates {\n      from\n      to\n    }\n  }\n}\n\nfragment Events_viewer on Viewer {\n  me {\n    id\n    profileType\n  }\n  ...Sportunity_viewer\n}\n\nfragment Filter_viewer on Viewer {\n  me {\n    id\n    appCountry\n  }\n  sports(first: 10, language: EN) {\n    edges {\n      node {\n        id\n        name {\n          EN\n          FR\n          DE\n          id\n        }\n        logo\n        levels {\n          id\n          EN {\n            name\n            skillLevel\n            description\n          }\n          FR {\n            name\n            skillLevel\n            description\n          }\n          DE {\n            name\n            skillLevel\n            description\n          }\n        }\n      }\n    }\n  }\n}\n\nfragment Events_sportunities on SportunityConnection {\n  pageInfo {\n    hasNextPage\n  }\n  edges {\n    node {\n      ...Sportunity_sportunity\n      id\n      title\n      beginning_date\n      ending_date\n      sport {\n        sport {\n          name {\n            EN\n            FR\n            DE\n            id\n          }\n          logo\n          levels {\n            EN {\n              name\n              skillLevel\n            }\n            FR {\n              name\n              skillLevel\n            }\n            DE {\n              name\n              skillLevel\n            }\n            id\n          }\n          id\n        }\n        allLevelSelected\n        levels {\n          id\n          EN {\n            name\n            skillLevel\n          }\n          FR {\n            name\n            skillLevel\n          }\n          DE {\n            name\n            skillLevel\n          }\n        }\n      }\n      venue {\n        name\n        id\n      }\n      address {\n        address\n        city\n        country\n        position {\n          lat\n          lng\n        }\n      }\n      participants {\n        id\n      }\n      price {\n        currency\n        cents\n      }\n      mode\n      kind\n      status\n    }\n  }\n}\n\nfragment FindSportunityMap_sportunities on SportunityConnection {\n  edges {\n    node {\n      id\n      title\n      beginning_date\n      ending_date\n      sport {\n        sport {\n          name {\n            EN\n            id\n          }\n          levels {\n            EN {\n              name\n            }\n            id\n          }\n          logo\n          id\n        }\n        allLevelSelected\n        levels {\n          id\n          EN {\n            name\n          }\n        }\n      }\n      venue {\n        name\n        id\n      }\n      address {\n        address\n        city\n        country\n        position {\n          lat\n          lng\n        }\n      }\n      participants {\n        id\n      }\n      price {\n        currency\n        cents\n      }\n      mode\n      kind\n      status\n    }\n  }\n}\n\nfragment Sportunity_sportunity on Sportunity {\n  id\n  title\n  description\n  beginning_date\n  ending_date\n  survey {\n    isSurveyTransformed\n    surveyDates {\n      answers {\n        user {\n          id\n          pseudo\n        }\n        answer\n      }\n    }\n  }\n  sportunityType {\n    id\n    name {\n      EN\n      FR\n      id\n    }\n  }\n  sportunityTypeStatus {\n    id\n    name {\n      EN\n      FR\n      id\n    }\n  }\n  score {\n    currentTeam\n    adversaryTeam\n  }\n  game_information {\n    opponent {\n      organizerPseudo\n      unknownOpponent\n      lookingForAnOpponent\n      organizer {\n        id\n        pseudo\n        avatar\n      }\n      invitedOpponents(last: 5) {\n        edges {\n          node {\n            id\n            members {\n              id\n            }\n          }\n        }\n      }\n    }\n  }\n  address {\n    address\n    city\n    country\n    position {\n      lat\n      lng\n    }\n  }\n  status\n  kind\n  venue {\n    id\n    name\n  }\n  infrastructure {\n    id\n    name\n  }\n  participants {\n    id\n  }\n  price {\n    currency\n    cents\n  }\n  paymentStatus {\n    status\n    user {\n      id\n    }\n    price {\n      currency\n      cents\n    }\n    id\n  }\n  organizers {\n    organizer {\n      id\n      pseudo\n      avatar\n    }\n    isAdmin\n    role\n    secondaryOrganizerType {\n      id\n      name {\n        FR\n        EN\n        DE\n        ES\n        id\n      }\n    }\n    customSecondaryOrganizerType\n    id\n  }\n  sport {\n    sport {\n      logo\n      id\n      name {\n        EN\n        FR\n        DE\n        id\n      }\n      assistantTypes {\n        id\n        name {\n          FR\n          EN\n          DE\n          ES\n          id\n        }\n      }\n      levels {\n        id\n        EN {\n          name\n          skillLevel\n        }\n        FR {\n          name\n          skillLevel\n        }\n        DE {\n          name\n          skillLevel\n        }\n      }\n    }\n    allLevelSelected\n    levels {\n      id\n      EN {\n        name\n        skillLevel\n      }\n      FR {\n        name\n        skillLevel\n      }\n      DE {\n        name\n        skillLevel\n      }\n    }\n  }\n}\n\nfragment Sportunity_viewer on Viewer {\n  id\n  me {\n    id\n    profileType\n    subAccounts {\n      id\n    }\n  }\n  sportunity {\n    ...Sportunity_sportunity\n    id\n  }\n}\n",
  "metadata": {},
  "fragment": {
    "kind": "Fragment",
    "name": "router_FindSportunity_Query",
...
// prettier-ignore
(node/*: any*/).hash = '3264aaac7f534f76872a2aed99c40030';
module.exports = node;
